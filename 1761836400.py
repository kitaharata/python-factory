...
class Region:
    def __init__(self, id, region, points=None, children=None):
        self.id = id
        self.region = region
        self.points = [Point(**p) for p in points] if points else []
        self.children = [Region(**c) for c in children] if children else []

    def __repr__(self):
        return f"Region(id={self.id}, region={self.region}, points={len(self.points)}, children={len(self.children)})"
                            ...
                            "points": [
                                {
                                    "x": 80,
                                    "y": 90,
                                    "label": "Deepest_SW_Point",
                                }
                            ],
                            "children": [
                                {
                                    "id": "R4d_3a",
                                    "region": [75, 87.5, 6.25, 6.25],
                                    "points": [],
                                },
                                {
                                    "id": "R4d_3b",
                                    "region": [81.25, 87.5, 6.25, 6.25],
                                    "points": [],
                                },
                                {
                                    "id": "R4d_3c",
                                    "region": [75, 93.75, 6.25, 6.25],
                                    "points": [],
                                },
                                {
                                    "id": "R4d_3d",
